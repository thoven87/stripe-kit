...
func XCTAssertEqualAsync<T>(
  _ expression1: @autoclosure () async throws -> T,
  _ expression2: @autoclosure () async throws -> T, accuracy: T,
...
func XCTAssertTrueAsync(
  _ predicate: @autoclosure () async throws -> Bool, file: StaticString = #filePath,
  line: UInt = #line
) async rethrows {
...
func XCTAssertThrowsErrorAsync<T>(
  ...
  do {
    ...
    XCTAssertThrowsError(
      try { () throws -> Void in }, message(), file: file, line: line, errorHandler)
  } catch {
    XCTAssertThrowsError(
      try { () throws -> Void in throw error }, message(), file: file, line: line, errorHandler)
  }
}
