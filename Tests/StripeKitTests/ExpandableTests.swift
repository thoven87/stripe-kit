...
@Suite struct ExpandableTests {

    @Test func dynamicExpandable_decodesProperly() throws {
        let fee = """
            {
                ...
                "originating_transaction": {
                  ...
                  "billing_details": {
                    "address": {
                      "city": null, "country": null, "line1": null,
                      "line2": null, "postal_code": null, "state": null
                    },
                  ...
                  "refunds": {
                    ...
                    "total_count": 0, "url": "/v1/charges/ch_1G7XzFAU9AiAmxbBuFTA65QG/refunds"
                  },
                  "review": null,
                  "shipping": null,
                  "source": null,
                  ...
                  "transfer_data": { "amount": null, "destination": "acct_1G7UfdEnR8BaFqPr" },
        ...
        #expect(appFee.$originatingTransaction(as: Charge.self) != nil)
        #expect(appFee.$originatingTransaction(as: Transfer.self) == nil)
    }

    @Test func expandable_decodesProperly_whenTopLevelField_isMissing() throws {
        let objectMissingExpandableTransferFieldOnCharge = """
            {
              "object": {
                  ...
                  "data": [
                    {
                      ...
                      "shipping": {
                        "address": {
                          "city": "San Francisco", "country": "US", "line1": "510 Townsend St",
                          "line2": null, "postal_code": "94103", "state": "CA"
                        },
                        "carrier": null, "name": "Jenny Rosen", "phone": null,
                ...
                "shipping": {
                  ...
                  "carrier": null, "name": "Jenny Rosen", "phone": null, "tracking_number": null
                },
                "source": null,
                "statement_descriptor": null,
                "statement_descriptor_suffix": null,
    ...
    @Test func expandable_nullEncodingDecoding() throws {
        let session = """
            {
              "amountTotal": 100,
              "id": "cs_test_ffff",
              ...
              "metadata": {},
              "totalDetails": {
                "amountShipping": 0, "amountTax": 0, "amountDiscount": 0
              },
              "setupIntent": null,
    ...
    @Test func expandableCollection_decodesProperly() throws {
        ...
        let discounts = """
            {
                "discounts": [
                    { "id": "di_1234", "object": "discount" },
                    { "id": "di_12345", "object": "discount" }
                ]
            }
            """.data(using: .utf8)!
        ...
        #expect(simple.$discounts?.count == 2)
        #expect(simple.$discounts?[0].id == "di_1234")
        #expect(simple.$discounts?[1].id == "di_12345")
    }
}
