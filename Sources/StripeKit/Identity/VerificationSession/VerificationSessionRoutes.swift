...
public protocol VerificationSessionRoutes: StripeAPIRoute {
  ...
  func retrieve(verificationSessionId: String, expand: [String]?) async throws
    -> VerificationSession
...
public struct StripeVerificationSessionRoutes: VerificationSessionRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: verificationsession, body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> VerificationSessionList {
    ...
    return try await apiHandler.send(
      method: .GET, path: verificationsession, query: queryParams, headers: headers)
  }

  public func retrieve(verificationSessionId: String, expand: [String]? = nil) async throws
    -> VerificationSession
  {
    var queryParams = ""
    if let expand {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(verificationsession)/\(verificationSessionId)", query: queryParams,
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(verificationsession)/\(verificationSessionId)",
  ...
  public func cancel(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(verificationsession)/\(verificationSessionId)/cancel",
  ...
  public func redact(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(verificationsession)/\(verificationSessionId)/redact",
      query: queryParams, headers: headers)
  }
}
