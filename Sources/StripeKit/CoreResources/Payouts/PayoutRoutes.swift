...
public protocol PayoutRoutes: StripeAPIRoute {
  ...
  func reverse(payout: String, metadata: [String: String]?, expand: [String]?) async throws
    -> Payout
}
...
public struct StripePayoutRoutes: PayoutRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: payouts, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(payout: String, expand: [String]? = nil) async throws -> Payout {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(payouts)/\(payout)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(payouts)/\(payout)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PayoutsList {
    ...
    return try await apiHandler.send(
      method: .GET, path: payouts, query: queryParams, headers: headers)
  }
  ...
  public func cancel(payout: String, expand: [String]? = nil) async throws -> Payout {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(payouts)/\(payout)/cancel", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func reverse(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(payouts)/\(payout)/reverse", body: .string(body.queryParameters),
      headers: headers)
  }
}
