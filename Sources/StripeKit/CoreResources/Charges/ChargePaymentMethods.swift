...
public struct ChargePaymentMethodDetailsACHDebit: Codable {
  ...
  public init(
    accountHolderType: ChargePaymentMethodDetailsACHDebitAccountHolderType? = nil,
    bankName: String? = nil,
    country: String? = nil,
...
public struct ChargePaymentMethodDetailsCardThreeDSecure: Codable {
  ...
  public init(
    authenticationFlow: ChargePaymentMethodDetailsCardThreeDSecureAuthenticationFlow? = nil,
...
public struct ChargePaymentMethodDetailsCardWallet: Codable {
  ...
  public init(
    amexExpressCheckout: ChargePaymentMethodDetailsAmexExpressCheckout? = nil,
...
public struct ChargePaymentMethodDetailsCardPresentReceipt: Codable {
  ...
  public init(
    accountType: ChargePaymentMethodDetailsCardPresentReceiptAccountType? = nil,
...
public struct ChargePaymentMethodDetailsEPS: Codable {
  ...
  public init(
    bank: ChargePaymentMethodDetailsEPSBank? = nil,
    verifiedName: String? = nil
  ) {
    self.bank = bank
    self.verifiedName = verifiedName
...
public struct ChargePaymentMethodDetailsFpx: Codable {
  ...
  public init(
    bank: ChargePaymentMethodDetailsFpxBank? = nil,
    transactionId: String? = nil
  ) {
    self.bank = bank
    self.transactionId = transactionId
...
public struct ChargePaymentMethodDetailsIdeal: Codable {
  ...
  public init(
    bank: ChargePaymentMethodDetailsIdealBank? = nil,
    bic: String? = nil,
    generatedSepaDebit: String? = nil,
    generatedSepaDebitMandate: String? = nil,
    ibanLast4: String? = nil,
...
public struct ChargePaymentMethodDetailsInteracPresent: Codable {
  ...
  public init(
    brand: ChargePaymentMethodDetailsInteracPresentBrand? = nil,
    cardholderName: String? = nil,
    country: String? = nil,
    emvAuthData: String? = nil,
    expMonth: Int? = nil,
...
public struct ChargePaymentMethodDetailsInteracPresentReceipt: Codable {
  ...
  public init(
    accountType: ChargePaymentMethodDetailsInteracPresentReceiptAccountType? = nil,
    applicationCryptogram: String? = nil,
    applicationPreferredName: String? = nil,
    authorizationCode: String? = nil,
    authorizationResponseCode: String? = nil,
...
public struct ChargePaymentMethodDetailsKlarna: Codable {
  ...
  public init(
    paymentMethodCategory: ChargePaymentMethodDetailsKlarnaPaymentMethodCategory? = nil,
...
public struct ChargePaymentMethodDetailsP24: Codable {
  ...
  public init(
    bank: ChargePaymentMethodDetailsP24Bank? = nil,
...
public struct ChargePaymentMethodDetailsPaypalSellerProtection: Codable {
  ...
  public init(
    disputeCategories: [ChargePaymentMethodDetailsPaypalSellerProtectionDisputeCategory]? = nil,
...
public struct ChargePaymentMethodDetailsUSBankAccount: Codable {
  ...
  public init(
    accountHolderType: ChargePaymentMethodDetailsUSBankAccountAccountHolderType? = nil,
