...
public struct Charge: Codable, Sendable {
    ...
    public var radarOptions: ChargeRadarOptions?
    ...
    public init(
        ...
        radarOptions: ChargeRadarOptions? = nil,
...
public struct ChargeFraudDetails: Codable, Sendable {
    ...
    public init(
        userReport: ChargeFraudDetailsReportType? = nil,
...
public struct ChargePaymentMethodDetails: Codable, Sendable {
    ...
    public init(
        achCreditTransfer: ChargePaymentMethodDetailsACHCreditTransfer? = nil,
...
public struct ChargeRadarOptions: Codable, Sendable {
