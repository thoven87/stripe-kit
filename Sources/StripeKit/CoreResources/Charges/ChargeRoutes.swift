...
public struct StripeChargeRoutes: ChargeRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: charge, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(charge: String, expand: [String]? = nil) async throws -> Charge {
    ...
    return try await apiHandler.send(
      method: .GET, path: charges + charge, query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: charges + charge, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func capture(
    ...
    return try await apiHandler.send(
      method: .POST, path: charges + charge + "/capture", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]?) async throws -> ChargeList {
    ...
    return try await apiHandler.send(
      method: .GET, path: charge, query: queryParams, headers: headers)
  }
  ...
  public func search(
    ...
    limit: Int? = nil,
    page: String? = nil
  ) async throws -> ChargeSearchResult {
