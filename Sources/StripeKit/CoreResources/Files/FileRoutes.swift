...
public protocol FileRoutes: StripeAPIRoute {
  ...
  mutating func create(file: Data, purpose: FilePurpose, fileLinkData: [String: Any]?) async throws
    -> File
...
public struct StripeFileRoutes: FileRoutes {
  ...
  public mutating func create(file: Data, purpose: FilePurpose, fileLinkData: [String: Any]? = nil)
    async throws -> File
  {
    var body: Data = Data()
    ...
    return try await apiHandler.send(
      method: .POST, path: filesupload, body: .data(body), headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> FileUploadList {
    ...
    return try await apiHandler.send(
      method: .GET, path: files, query: queryParams, headers: headers)
  }
}
