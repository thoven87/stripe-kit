...
public struct StripeFileLinkRoutes: FileLinkRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: filelinks, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(link: String, expand: [String]? = nil) async throws -> FileLink {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(filelinks)/\(link)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(filelinks)/\(link)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> FileLinkList {
    ...
    return try await apiHandler.send(
      method: .GET, path: filelinks, query: queryParams, headers: headers)
  }
}
