...
public protocol SetupIntentsRoutes: StripeAPIRoute {
  ...
  func retrieve(intent: String, clientSecret: String?, expand: [String]?) async throws
    -> SetupIntent
  ...
  /// - Parameter expand: Specifies which fields in the response should be expanded.
  func cancel(intent: String, cancellationReason: SetupIntentCancellationReason?, expand: [String]?)
    async throws -> SetupIntent
...
public struct StripeSetupIntentsRoutes: SetupIntentsRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: setupintents, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(setupintents)/\(intent)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(setupintents)/\(intent)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func confirm(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(setupintents)/\(intent)/confirm", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func cancel(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(setupintents)/\(intent)/cancel", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> SetupIntentsList {
    ...
    return try await apiHandler.send(
      method: .GET, path: setupintents, query: queryParams, headers: headers)
  }
  ...
  public func verifyMicrodeposits(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(setupintents)/\(intent)/verify_microdeposits",
