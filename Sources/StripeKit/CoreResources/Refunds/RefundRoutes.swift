...
public struct StripeRefundRoutes: RefundRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: refunds, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(refund: String, expand: [String]?) async throws -> Refund {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(refunds)/\(refund)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(refunds)/\(refund)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func cancel(refund: String, expand: [String]? = nil) async throws -> Refund {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(refunds)/\(refund)/cancel", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> RefundsList {
    ...
    return try await apiHandler.send(
      method: .GET, path: refunds, query: queryParams, headers: headers)
  }
}
