...
public protocol CustomerRoutes: StripeAPIRoute {
    ...
    func search(query: String, limit: Int?, page: String?, expand: [String]?) async throws
    ...
    ///   - type: An optional filter on the list, based on the object type field. Without the filter, the list includes all current and future payment method types. If your integration expects only one type of payment method in the response, make sure to provide a type value.
    ///   - filter: A dictionary that will be used for the query parameters.
    func listPaymentMethods(customer: String, type: PaymentMethodType?, filter: [String: Any]?)
    ...
    /// - Parameters:
    ///   - customer: The ID of the customer.
    ///   - bankTransfer: Additional parameters for `bank_transfer` funding type.
    ///   - currency: Three-letter ISO currency code.
    ///   - fundingType: The `funding_type` to get the instructions for. Only `bank_transfer` is supported.
    ///   - expand: Specifies which fields in the response should be expanded.
    func createFundingInstructions(
        customer: String,
        bankTransfer: [String: Any],
        currency: Currency,
        fundingType: String,
        expand: [String]?
    ) async throws -> CustomerFundingInstructions
}
...
public struct StripeCustomerRoutes: CustomerRoutes {
    ...
    public func create(
        ...
        return try await apiHandler.send(
            method: .POST, path: customers, body: .string(body.queryParameters), headers: headers)
    }
    ...
    public func retrieve(customer: String, expand: [String]? = nil) async throws -> Customer {
        ...
        return try await apiHandler.send(
            method: .GET, path: self.customer + customer, query: queryParams, headers: headers)
    }
    ...
    public func update(
        ...
        return try await apiHandler.send(
            method: .POST, path: self.customer + customer, body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func listAll(filter: [String: Any]?) async throws -> CustomerList {
        ...
        return try await apiHandler.send(
            method: .GET, path: customers, query: queryParams, headers: headers)
    }
    ...
    public func search(
        ...
        page: String? = nil,
        expand: [String]? = nil
    ) async throws -> CustomerSearchResult {
    ...
    public func listPaymentMethods(
        customer: String, type: PaymentMethodType? = nil, filter: [String: Any]? = nil
    ) async throws -> PaymentMethodList {
        var queryParams = "customer=\(customer)"
        if let type { queryParams += "&type=\(type.rawValue)" }
        if let filter { queryParams += "&\(filter.queryParameters)" }
        return try await apiHandler.send(
            method: .GET, path: "\(customers)/\(customer)/payment_methods", query: queryParams,
            headers: headers)
    }
    ...
    public func createFundingInstructions(
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(customers)/\(customer)/funding_instructions",
