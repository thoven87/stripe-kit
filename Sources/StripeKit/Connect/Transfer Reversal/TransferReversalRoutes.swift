...
public struct StripeTransferReversalRoutes: TransferReversalRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(transferreversals)/\(id)/reversals",
      body: .string(body.queryParameters), headers: headers)
  }

  public func retrieve(id: String, transfer: String, expand: [String]? = nil) async throws
    -> TransferReversal
  {
    var queryParams = ""
    if let expand {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(transferreversals)/\(id)/reversals/\(id)", query: queryParams,
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(transferreversals)/\(id)/reversals/\(id)",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func listAll(id: String, filter: [String: Any]? = nil) async throws -> TransferReversalList
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(transferreversals)/\(id)/reversals", query: queryParams,
      headers: headers)
  }
}
