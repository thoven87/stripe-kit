...
public protocol ApplicationFeeRefundRoutes: StripeAPIRoute {
  ...
  func create(
    ...
    expand: [String]?
  ) async throws -> ApplicationFeeRefund
...
public struct StripeApplicationFeeRefundRoutes: ApplicationFeeRefundRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(applicationfeesrefund)/\(fee)/refunds",
  ...
  public func retrieve(
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(applicationfeesrefund)/\(fee)/refunds/\(refund)", query: queryParams,
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(applicationfeesrefund)/\(fee)/refunds/\(refund)",
      body: .string(body.queryParameters), headers: headers)
  }

  public func listAll(fee: String, filter: [String: Any]? = nil) async throws
    -> ApplicationFeeRefundList
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(applicationfeesrefund)/\(fee)/refunds", query: queryParams,
      headers: headers)
  }
}
