...
public struct StripeExternalAccountsRoutes: ExternalAccountsRoutes {
  ...
  public func createBankAccount(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(accounts)/\(account)/external_accounts",
      body: .string(body.queryParameters), headers: headers)
  }

  public func retrieveBankAccount(
    account: String,
    id: String,
    expand: [String]? = nil
  ) async throws -> BankAccount {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(accounts)/\(account)/external_accounts/\(id)",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func updateBankAccount(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(accounts)/\(account)/external_accounts/\(id)",
      body: .string(body.queryParameters), headers: headers)
  }

  public func deleteBankAccount(account: String, id: String) async throws -> DeletedObject {
    try await apiHandler.send(
      method: .DELETE, path: "\(accounts)/\(account)/external_accounts/\(id)", headers: headers)
  }

  public func listAllBankAccounts(account: String, filter: [String: Any]? = nil) async throws
    -> BankAccountList
  {
    var queryParams = ""
    if let filter {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(accounts)/\(account)/external_accounts", query: queryParams,
      headers: headers)
  }
  ...
  public func retrieveCard(account: String, id: String, expand: [String]? = nil) async throws
    -> Card
  {
    var body: [String: Any] = [:]
