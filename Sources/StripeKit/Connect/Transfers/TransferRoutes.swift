...
public struct StripeTransferRoutes: TransferRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: transfers, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(transfer: String, expand: [String]? = nil) async throws -> Transfer {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(transfers)/\(transfer)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(transfers)/\(transfer)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> TransferList {
    ...
    return try await apiHandler.send(
      method: .GET, path: transfers, query: queryParams, headers: headers)
  }
}
