...
public struct ConnectAccountCapablities: Codable {
  ...
  public init(
    acssDebitPayments: ConnectAccountCapabilitiesStatus? = nil,
...
public struct ConnectAccountRequirements: Codable {
  ...
  public init(
    alternatives: [ConnectAccountRequirementsAlternative]? = nil,
...
public struct ConnectAccountRequirementsError: Codable {
  ...
  public init(
    code: ConnectAccountRequirementsErrorCode? = nil,
    reason: String? = nil,
...
public struct ConnectAccountFutureRequirements: Codable {
  ...
  public init(
    alternatives: [ConnectAccountFutureRequirementsAlternative]? = nil,
    currentDeadline: Date? = nil,
    currentlyDue: [String]? = nil,
...
public struct ConnectAccountSettings: Codable {
  ...
  public init(
    bacsDebitPayments: ConnectAccountSettingsBacsDebitPayments? = nil,
...
public struct ConnectAccountSettingsCardPayments: Codable {
  ...
  public init(
    declineOn: ConnectAccountSettingsCardPaymentsDeclineOn? = nil,
