...
public protocol AccountRoutes: StripeAPIRoute {
    ...
    func createLoginLink(account: String, expand: [String]?) async throws -> LoginLink
}
...
public struct StripeConnectAccountRoutes: AccountRoutes {
    ...
    public func create(
        ...
        return try await apiHandler.send(
            method: .POST, path: accounts, body: .string(body.queryParameters), headers: headers)
    }
    ...
    public func update(
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(accounts)/\(account)", body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func reject(account: String, reason: ConnectAccountRejectReason) async throws
        -> ConnectAccount
    {
        try await apiHandler.send(
            method: .POST, path: "\(accounts)/\(account)/reject",
            body: .string(["reason": reason.rawValue].queryParameters), headers: headers)
    }
    ...
    public func listAll(filter: [String: Any]? = nil) async throws -> ConnectAccountList {
        ...
        return try await apiHandler.send(
            method: .GET, path: accounts, query: queryParams, headers: headers)
    }

    public func createLoginLink(account: String, expand: [String]? = nil) async throws -> LoginLink
    {
        var body: [String: Any] = [:]
        if let expand { body["expand"] = expand }
        return try await apiHandler.send(
            method: .POST, path: "\(accounts)/\(account)/login_links",
