...
public struct StripeSecretRoutes: SecretRoutes {
  ...
  public func setSecret(
    ...
    return try await apiHandler.send(
      method: .POST, path: secrets, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func find(
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(secrets)/find", body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func delete(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(secrets)/delete", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  ) async throws -> SecretList {
    var queryParams = scope.queryParameters
    if let filter {
      queryParams += "&" + filter.queryParameters
    }
    return try await apiHandler.send(
      method: .GET, path: secrets, query: queryParams, headers: headers)
  }
}
