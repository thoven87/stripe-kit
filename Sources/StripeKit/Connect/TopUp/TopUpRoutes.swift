...
public struct StripeTopUpRoutes: TopUpRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: topups, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(topup: String, expand: [String]? = nil) async throws -> TopUp {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(topups)/\(topup)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(topups)/\(topup)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> TopUpList {
    ...
    return try await apiHandler.send(
      method: .GET, path: topups, query: queryParams, headers: headers)
  }
  ...
  public func cancel(topup: String, expand: [String]? = nil) async throws -> TopUp {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(topups)/\(topup)/cancel", body: .string(body.queryParameters),
      headers: headers)
  }
}
