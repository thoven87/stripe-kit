...
public protocol TerminalReaderRoutes: StripeAPIRoute {
  ...
  /// - Returns: Returns an updated ``TerminalReader`` resource.
  func simulatePresentPaymentMethod(
    reader: String,
...
public struct StripeTerminalReaderRoutes: TerminalReaderRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: terminalreaders, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(reader: String, expand: [String]? = nil) async throws -> TerminalReader {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(terminalreaders)/\(reader)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)", body: .string(body.queryParameters),
      headers: headers)
  }

  public func delete(reader: String) async throws -> DeletedObject {
    try await apiHandler.send(
      method: .DELETE, path: "\(terminalreaders)/\(reader)", headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> TerminalReaderList {
    ...
    return try await apiHandler.send(
      method: .GET, path: terminalreaders, query: queryParams, headers: headers)
  }

  public func handoffPaymentIntent(
    reader: String,
    paymentIntent: String,
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)/process_payment_intent",
      body: .string(body.queryParameters), headers: headers)
  }

  public func handoffSetupIntent(
    reader: String,
    customerConsentCollected: Bool,
    setupIntent: String,
    expand: [String]? = nil
    ...
    var body: [String: Any] = [
      "customer_consent_collected": customerConsentCollected,
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)/process_setup_intent",
      body: .string(body.queryParameters), headers: headers)
  }

  public func setupReaderDisplay(
    reader: String,
    type: String,
    cart: [String: Any]? = nil,
    expand: [String]? = nil
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)/set_reader_display",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func refund(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)/refund_payment",
      body: .string(body.queryParameters), headers: headers)
  }

  public func cancelCurrentAction(reader: String, expand: [String]? = nil) async throws
    -> TerminalReader
  {
    var body: [String: Any] = [:]
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalreaders)/\(reader)/cancel_action",
      body: .string(body.queryParameters), headers: headers)
  }

  public func simulatePresentPaymentMethod(
    reader: String,
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(testhelpers)/\(reader)/present_payment_method",
      body: .string(body.queryParameters), headers: headers)
  }
}
