...
public struct StripeTerminalConfigurationRoutes: TerminalConfigurationRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: terminalconfigurations, body: .string(body.queryParameters),
      headers: headers)
  }

  public func retrieve(config: String, expand: [String]? = nil) async throws
    -> TerminalConfiguration
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(terminalconfigurations)/\(config)",
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(terminalconfigurations)/\(config)",
      body: .string(body.queryParameters), headers: headers)
  }

  public func delete(config: String) async throws -> DeletedObject {
    try await apiHandler.send(
      method: .DELETE, path: "\(terminalconfigurations)/\(config)", headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> TerminalConfigurationList {
    ...
    return try await apiHandler.send(
      method: .GET, path: terminalconfigurations, query: queryParams, headers: headers)
  }
}
