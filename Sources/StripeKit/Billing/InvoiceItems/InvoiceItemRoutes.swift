...
public struct StripeInvoiceItemRoutes: InvoiceItemRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: invoiceitems, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(invoiceItem: String, expand: [String]? = nil) async throws -> InvoiceItem {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(invoiceitems)/\(invoiceItem)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(invoiceitems)/\(invoiceItem)", body: .string(body.queryParameters),
      headers: headers)
  }

  public func delete(invoiceItem: String) async throws -> DeletedObject {
    try await apiHandler.send(
      method: .DELETE, path: "\(invoiceitems)/\(invoiceItem)", headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> InvoiceItemList {
    ...
    return try await apiHandler.send(
      method: .GET, path: invoiceitems, query: queryParams, headers: headers)
  }
}
