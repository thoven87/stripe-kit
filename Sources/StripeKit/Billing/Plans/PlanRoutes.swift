...
public struct StripePlanRoutes: PlanRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: plans, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(plan: String, expand: [String]? = nil) async throws -> Plan {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(plans)/\(plan)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(plans)/\(plan)", body: .string(body.queryParameters), headers: headers
    )
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PlanList {
    ...
    return try await apiHandler.send(
      method: .GET, path: plans, query: queryParams, headers: headers)
  }
}
