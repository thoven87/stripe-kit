...
public protocol QuoteRoutes: StripeAPIRoute {
  ...
  func retrieveUpfrontLineItems(quote: String, filter: [String: Any]?) async throws
    -> QuoteLineItemList
...
public struct StripeQuoteRoutes: QuoteRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: quotes, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(quote: String, expand: [String]? = nil) async throws -> Quote {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(quotes)/\(quote)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func finalize(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)/finalize", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func accept(quote: String, expand: [String]? = nil) async throws -> Quote {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)/accept", query: queryParams, headers: headers)
  }
  ...
  public func cancel(quote: String, expand: [String]? = nil) async throws -> Quote {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)/cancel", query: queryParams, headers: headers)
  }
  ...
  public func retrieveLineItems(quote: String, filter: [String: Any]? = nil) async throws
    -> QuoteLineItemList
  {
    var queryParams = ""
    if let filter {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)/line_items", query: queryParams, headers: headers)
  }

  public func retrieveUpfrontLineItems(quote: String, filter: [String: Any]? = nil) async throws
    -> QuoteLineItemList
  {
    var queryParams = ""
    if let filter {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(quotes)/\(quote)/computed_upfront_line_items", query: queryParams,
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> QuoteList {
    ...
    return try await apiHandler.send(
      method: .GET, path: quotes, query: queryParams, headers: headers)
  }
}
