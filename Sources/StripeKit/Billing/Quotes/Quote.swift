...
public struct QuoteComputedRecurringTotalDetailsBreakdown: Codable {
  ...
  public init(
    discounts: [QuoteComputedRecurringTotalDetailsBreakdownDiscount]? = nil,
...
public struct QuoteComputedUpfrontTotalDetailsBreakdown: Codable {
  ...
  public init(
    discounts: [QuoteComputedUpfrontTotalDetailsBreakdownDiscount]? = nil,
...
public struct QuoteTotalDetailsBreakdown: Codable {
  ...
  public init(
    discounts: [QuoteTotalDetailsBreakdownDiscount]? = nil,
