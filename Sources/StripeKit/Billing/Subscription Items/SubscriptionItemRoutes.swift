...
public struct StripeSubscriptionItemRoutes: SubscriptionItemRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: subscirptionitems, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscirptionitems)/\(item)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func delete(
    ...
    return try await apiHandler.send(
      method: .DELETE, path: "\(subscirptionitems)/\(item)", body: .string(body.queryParameters),
      headers: headers)
  }

  public func listAll(subscription: String, filter: [String: Any]? = nil) async throws
    -> SubscriptionItemList
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: subscirptionitems, query: queryParams, headers: headers)
  }
}
