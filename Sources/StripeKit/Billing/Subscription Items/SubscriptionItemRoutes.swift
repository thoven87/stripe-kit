...
public struct StripeSubscriptionItemRoutes: SubscriptionItemRoutes {
    ...
    public func create(
        ...
        return try await apiHandler.send(
            method: .POST, path: subscirptionitems, body: .string(body.queryParameters),
            headers: headers)
    }

    public func retrieve(item: String) async throws -> SubscriptionItem {
        try await apiHandler.send(
            method: .GET, path: "\(subscirptionitems)/\(item)", headers: headers)
    }
    ...
    public func update(
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(subscirptionitems)/\(item)",
    ...
    public func delete(
        ...
        return try await apiHandler.send(
            method: .DELETE, path: "\(subscirptionitems)/\(item)",
            body: .string(body.queryParameters),
            headers: headers)
    }
