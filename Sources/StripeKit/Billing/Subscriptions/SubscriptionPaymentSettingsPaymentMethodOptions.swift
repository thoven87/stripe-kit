...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit: Codable, Sendable {
    ...
    public var mandateOptions:
        SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptions?
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptions: Codable, Sendable {
    ...
    public init(
        amount: Int? = nil,
        amountType: SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptionsAmountType? =
            nil
    ) {
        self.amount = amount
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalance: Codable, Sendable {
    ...
    public var fundingType:
        SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceFundingType?

    public init(
        bankTransfer: SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransfer? =
            nil,
        fundingType: SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceFundingType? =
            nil
    ) {
