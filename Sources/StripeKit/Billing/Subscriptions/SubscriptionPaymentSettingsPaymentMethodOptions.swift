...
public struct SubscriptionPaymentSettingsPaymentMethodOptions: Codable {
  ...
  public init(
    acssDebit: SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit? = nil,
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit: Codable {
  ...
  public init(
    mandateOptions: SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptions? = nil,
    verificationMethod:
      SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitVerificationMethod? = nil
  ) {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptions: Codable {
  ...
  public var transactionType:
    SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptionsTransactionType?

  public init(
    transactionType:
      SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptionsTransactionType? = nil
  ) {
    self.transactionType = transactionType
  }
}

public enum SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitManadteOptionsTransactionType:
  String, Codable
{
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitVerificationMethod: String,
  Codable
{
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCard: Codable {
  ...
  public init(
    mandateOptions: SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptions? = nil,
    network: String? = nil,
    requestThreeDSecure: SubscriptionPaymentSettingsPaymentMethodOptionsCardRequestThreedSecure? =
      nil
  ) {
    self.mandateOptions = mandateOptions
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptionsAmountType: String,
  Codable
{
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalance: Codable {
  ...
  public init(
    bankTransfer: SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransfer? = nil,
...
public struct
  SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferEUBankTransfer: Codable
{
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransferType: String,
  Codable
{
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalanceFundingType: String,
  Codable
{
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccount: Codable {
  ...
  public init(
    financialConnections:
      SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnections? = nil,
    verificationMethod:
      SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountVerificationMethod? = nil
  ) {
...
public struct SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountFinancialConnections:
  Codable
{
...
public enum SubscriptionPaymentSettingsPaymentMethodOptionsUSBankAccountVerificationMethod: String,
  Codable
{
  /// Instant verification with fallback to microdeposits.
  case automatic
