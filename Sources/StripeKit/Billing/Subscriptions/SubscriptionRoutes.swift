...
public struct StripeSubscriptionRoutes: SubscriptionRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: subscriptions, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> Subscription {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(subscriptions)/\(id)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscriptions)/\(subscription)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func resume(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscriptions)/\(subscription)/resume",
  ...
  public func cancel(
    ...
    return try await apiHandler.send(
      method: .DELETE, path: "\(subscriptions)/\(subscription)",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> SubscriptionList {
    ...
    return try await apiHandler.send(
      method: .GET, path: subscriptions, query: queryParams, headers: headers)
  }
