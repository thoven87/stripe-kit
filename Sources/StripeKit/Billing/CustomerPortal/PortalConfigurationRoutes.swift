...
public protocol PortalConfigurationRoutes: StripeAPIRoute {
  ...
  ) async throws -> PortalConfiguration
...
public struct StripePortalConfigurationRoutes: PortalConfigurationRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: portalconfiguration, body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(portalconfiguration)/\(configuration)",
  ...
  public func retrieve(configuration: String) async throws -> PortalConfiguration {
    try await apiHandler.send(
      method: .GET, path: "\(portalconfiguration)/\(configuration)", headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PortalConfigurationList {
    ...
    return try await apiHandler.send(
      method: .GET, path: portalconfiguration, query: queryParams, headers: headers)
  }
}
