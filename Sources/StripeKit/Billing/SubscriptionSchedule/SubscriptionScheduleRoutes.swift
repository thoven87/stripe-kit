...
public protocol SubscriptionScheduleRoutes: StripeAPIRoute {
  ...
  ///  - billingMode: The billing mode for subscriptions created by this schedule. Pass `["type": "flexible"]` to opt into flexible billing mode. Requires API version `2025-06-30.basil` or later.
...
public struct StripeSubscriptionScheduleRoutes: SubscriptionScheduleRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: subscriptionschedules, body: .string(body.queryParameters),
      headers: headers)
  }

  public func retrieve(schedule: String, expand: [String]? = nil) async throws
    -> SubscriptionSchedule
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(subscriptionschedules)/\(schedule)", query: queryParams,
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscriptionschedules)/\(schedule)",
  ...
  public func cancel(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscriptionschedules)/\(schedule)/cancel",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func release(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(subscriptionschedules)/\(schedule)/release",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> SubscriptionScheduleList {
    ...
    return try await apiHandler.send(
      method: .GET, path: subscriptionschedules, query: queryParams, headers: headers)
  }
}
