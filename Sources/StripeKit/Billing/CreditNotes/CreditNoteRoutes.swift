...
public protocol CreditNoteRoutes: StripeAPIRoute {
  ...
  func update(id: String, memo: String?, metadata: [String: String]?, expand: [String]?)
    async throws -> CreditNote
  ...
  func retrievePreviewLineItems(invoice: String, filter: [String: Any]?) async throws
    -> CreditNoteLineItemList
...
public struct StripeCreditNoteRoutes: CreditNoteRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: creditnotes, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func preview(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(creditnotes)/preview", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> CreditNote {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(creditnotes)/\(id)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(creditnotes)/\(id)", body: .string(body.queryParameters),
      headers: headers)
  }

  public func retrieveLineItems(id: String, filter: [String: Any]? = nil) async throws
    -> CreditNoteLineItemList
  {
    var queryParams = ""
    if let filter {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(creditnotes)/\(id)/lines", query: queryParams, headers: headers)
  }

  public func retrievePreviewLineItems(invoice: String, filter: [String: Any]? = nil) async throws
    -> CreditNoteLineItemList
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(creditnotes)/preview/lines", query: queryParams, headers: headers)
  }
  ...
  public func void(id: String, expand: [String]? = nil) async throws -> CreditNote {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(creditnotes)/\(id)/void", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> CreditNoteList {
    ...
    return try await apiHandler.send(
      method: .GET, path: creditnotes, query: queryParams, headers: headers)
  }
}
