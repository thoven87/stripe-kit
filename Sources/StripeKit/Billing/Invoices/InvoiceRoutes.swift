...
public protocol InvoiceRoutes: StripeAPIRoute {
    ...
    func retrieveLineItems(invoice: String, filter: [String: Any]?) async throws
        -> InvoiceLineItemList
...
public struct StripeInvoiceRoutes: InvoiceRoutes {
    ...
    public func create(
        ...
        if let issuer {
            issuer.forEach { body["issuer[\($0)]"] = $1 }
        }
        ...
        return try await apiHandler.send(
            method: .POST, path: invoices, body: .string(body.queryParameters), headers: headers)
    }
    ...
    public func retrieve(invoice: String, expand: [String]? = nil) async throws -> Invoice {
        ...
        return try await apiHandler.send(
            method: .GET, path: "\(invoices)/\(invoice)", query: queryParams, headers: headers)
    }
    ...
    public func update(
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)", body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func finalize(invoice: String, autoAdvance: Bool? = nil, expand: [String]? = nil)
        async throws -> Invoice
    {
        var body: [String: Any] = [:]
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)/finalize",
    ...
    public func pay(
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)/pay", body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func send(invoice: String, expand: [String]? = nil) async throws -> Invoice {
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)/send", body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func void(invoice: String, expand: [String]? = nil) async throws -> Invoice {
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)/void", body: .string(body.queryParameters),
            headers: headers)
    }
    ...
    public func markUncollectible(invoice: String, expand: [String]? = nil) async throws -> Invoice
    {
        ...
        return try await apiHandler.send(
            method: .POST, path: "\(invoices)/\(invoice)/mark_uncollectible",
            body: .string(body.queryParameters), headers: headers)
    }

    public func retrieveLineItems(invoice: String, filter: [String: Any]? = nil) async throws
        -> InvoiceLineItemList
    {
        var queryParams = ""
        if let filter {
        ...
        return try await apiHandler.send(
            method: .GET, path: "\(invoices)/\(invoice)/lines", query: queryParams, headers: headers
        )
    }
    ...
    public func retrieveUpcomingInvoice(filter: [String: Any]? = nil) async throws -> Invoice {
        ...
        return try await apiHandler.send(
            method: .GET, path: "\(invoices)/upcoming", query: queryParams, headers: headers)
    }

    public func retrieveUpcomingLineItems(filter: [String: Any]?) async throws
        -> InvoiceLineItemList
    {
        var queryParams = ""
        if let filter {
        ...
        return try await apiHandler.send(
            method: .GET, path: "\(invoices)/upcoming/lines", query: queryParams, headers: headers)
    }
    ...
    public func listAll(filter: [String: Any]? = nil) async throws -> InvoiceList {
        ...
        return try await apiHandler.send(
            method: .GET, path: invoices, query: queryParams, headers: headers)
    }

    public func search(query: String, limit: Int? = nil, page: String? = nil) async throws
        -> InvoiceSearchResult
    {
