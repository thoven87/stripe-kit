...
public protocol CardRoutes: StripeAPIRoute {
  ...
  func create(customer: String, source: Any, metadata: [String: String]?, expand: [String]?)
    async throws -> Card
...
public struct StripeCardRoutes: CardRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(cards)/\(customer)/sources", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func retrieve(id: String, customer: String, expand: [String]? = nil) async throws -> Card {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(cards)/\(customer)/sources/\(id)", query: queryParams, headers: headers
    )
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(cards)/\(customer)/sources/\(id)",
  ...
  public func delete(id: String, customer: String) async throws -> DeletedObject {
    try await apiHandler.send(
      method: .DELETE, path: "\(cards)/\(customer)/sources/\(id)", headers: headers)
  }
  ...
  public func listAll(customer: String, filter: [String: Any]? = nil) async throws -> CardList {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(cards)/\(customer)/sources", query: queryParams, headers: headers)
  }
}
