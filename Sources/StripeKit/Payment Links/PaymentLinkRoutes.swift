...
public struct StripePaymentLinkRoutes: PaymentLinkRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: paymentlinks, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> PaymentLink {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(paymentlinks)/\(id)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(paymentlinks)/\(id)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PaymentLinkList {
    ...
    return try await apiHandler.send(
      method: .GET, path: paymentlinks, query: queryParams, headers: headers)
  }

  public func retrieveLineItems(id: String, filter: [String: Any]? = nil) async throws
    -> PaymentLinkLineItemList
  {
    var queryParams = ""
    if let filter {
      queryParams = filter.queryParameters
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(paymentlinks)/\(id)/line_items", query: queryParams, headers: headers)
  }
}
