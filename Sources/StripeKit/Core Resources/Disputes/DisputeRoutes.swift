...
public struct StripeDisputeRoutes: DisputeRoutes {
  ...
  public func retrieve(dispute: String, expand: [String]?) async throws -> Dispute {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(disputes)/\(dispute)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(disputes)/\(dispute)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func close(dispute: String, expand: [String]?) async throws -> Dispute {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(disputes)/\(dispute)/close", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]?) async throws -> DisputeList {
    ...
    return try await apiHandler.send(
      method: .GET, path: disputes, query: queryParams, headers: headers)
  }
}
