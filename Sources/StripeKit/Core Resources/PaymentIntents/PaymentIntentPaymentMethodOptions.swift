...
public struct PaymentIntentPaymentMethodOptionsCardPresentRouting: Codable {
  ...
  public init(
    requestedPriority: PaymentIntentPaymentMethodOptionsCardPresentRoutingRequestedPriority? = nil
  ) {
...
public struct PaymentIntentPaymentMethodOptionsUSBankAccount: Codable {
  ...
  public init(
    financialConnections: PaymentIntentPaymentMethodOptionsUSBankAccountFinancialConnections? = nil,
