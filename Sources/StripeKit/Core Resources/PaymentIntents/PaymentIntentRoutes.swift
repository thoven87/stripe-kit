...
public protocol PaymentIntentRoutes: StripeAPIRoute {
  ...
  func cancel(
    intent: String, cancellationReason: PaymentIntentCancellationReason?, expand: [String]?
  ) async throws -> PaymentIntent
  ...
  /// - Returns: Returns a PaymentIntent object.
  func verifyMicroDeposits(intent: String, amounts: [Int]?, descriptorCode: String?) async throws
    -> PaymentIntent
  ...
  ///   - currency: Three-letter ISO currency code, in lowercase. Must be a supported currency.
  /// - Returns: Returns a PaymentIntent object.
  func reconcileCustomerBalance(intent: String, amount: Int?, currency: Currency?) async throws
    -> PaymentIntent
}
...
public struct StripePaymentIntentRoutes: PaymentIntentRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: paymentintents, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(intent: String, clientSecret: String?) async throws -> PaymentIntent {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(paymentintents)/\(intent)", query: query, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(paymentintents)/\(intent)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func confirm(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(paymentintents)/\(intent)/confirm",
  ...
  public func capture(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(paymentintents)/\(intent)/capture",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func cancel(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(paymentintents)/\(intent)/cancel",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PaymentIntentList {
    ...
    return try await apiHandler.send(
      method: .GET, path: paymentintents, query: queryParams, headers: headers)
  }
  ...
  public func search(
    ...
    limit: Int? = nil,
    page: String? = nil
  ) async throws -> PaymentIntentSearchResult {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(paymentintents)/search", query: queryParams.queryParameters,
      headers: headers)
  }
  ...
  public func reconcileCustomerBalance(
    intent: String, amount: Int? = nil, currency: Currency? = nil
  ) async throws -> PaymentIntent {
    var body: [String: Any] = [:]
