...
public struct StripeShippingRateRoutes: ShippingRateRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: shippingrates, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> ShippingRate {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(shippingrates)/\(id)", query: body.queryParameters, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(shippingrates)/\(id)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> ShippingRateList {
    ...
    return try await apiHandler.send(
      method: .GET, path: shippingrates, query: queryParams, headers: headers)
  }
}
