...
public struct StripePromotionCodesRoutes: PromotionCodesRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: promotionCodes, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(promotionCodes)/\(promotionCode)",
  ...
  public func retrieve(promotionCode: String) async throws -> PromotionCode {
    try await apiHandler.send(
      method: .GET, path: "\(promotionCodes)/\(promotionCode)", headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PromotionCodeList {
    ...
    return try await apiHandler.send(
      method: .GET, path: promotionCodes, query: queryParams, headers: headers)
  }
}
