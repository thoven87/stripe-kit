...
public struct PriceRecurring: Codable, Sendable {
    ...
    /// The ID of the meter tracking the usage of a metered price.
    public var meter: String?

    public init(
        aggregateUsage: PriceRecurringAggregateUsage? = nil,
...
public struct PriceCurrencyOption: Codable, Sendable {
    ...
    public init(
        customUnitAmount: PriceCurrencyOptionCustomUnitAmount? = nil,
