...
public struct StripePriceRoutes: PriceRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: prices, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(price: String, expand: [String]? = nil) async throws -> Price {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(prices)/\(price)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(prices)/\(price)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> PriceList {
    ...
    return try await apiHandler.send(
      method: .GET, path: prices, query: queryParams, headers: headers)
  }
  ...
  public func search(
    ...
    limit: Int? = nil,
    page: String? = nil
  ) async throws -> PriceSearchResult {
