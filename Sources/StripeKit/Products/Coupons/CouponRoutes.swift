...
public struct StripeCouponRoutes: CouponRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: coupons, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(coupon: String, expand: [String]? = nil) async throws -> Coupon {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(coupons)/\(coupon)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(coupons)/\(coupon)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> CouponList {
    ...
    return try await apiHandler.send(
      method: .GET, path: coupons, query: queryParams, headers: headers)
  }
}
