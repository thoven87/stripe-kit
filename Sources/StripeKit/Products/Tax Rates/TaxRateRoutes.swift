...
public struct StripeTaxRateRoutes: TaxRateRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: taxrates, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(taxrates)/\(taxRate)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> TaxRateList {
    ...
    return try await apiHandler.send(
      method: .GET, path: taxrates, query: queryParams, headers: headers)
  }
}
