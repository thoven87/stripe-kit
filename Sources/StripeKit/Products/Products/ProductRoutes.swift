...
public struct StripeProductRoutes: ProductRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: products, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> Product {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(products)/\(id)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(products)/\(product)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> ProductsList {
    ...
    return try await apiHandler.send(
      method: .GET, path: products, query: queryParams, headers: headers)
  }
