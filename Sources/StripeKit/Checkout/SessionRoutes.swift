...
public protocol SessionRoutes: Sendable {
  ...
  func retrieveLineItems(session: String, filter: [String: Any]?) async throws
    -> SessionLineItemList
}
...
public struct StripeSessionRoutes: SessionRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: sessions, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func expire(id: String, expand: [String]? = nil) async throws -> Session {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(sessions)/\(id)/expire", query: queryParams, headers: headers)
  }
  ...
  public func retrieve(id: String, expand: [String]? = nil) async throws -> Session {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(sessions)/\(id)", query: queryParams, headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> SessionList {
    ...
    return try await apiHandler.send(
      method: .GET, path: sessions, query: queryParams, headers: headers)
  }

  public func retrieveLineItems(session: String, filter: [String: Any]?) async throws
    -> SessionLineItemList
  {
    var queryParams = ""
    if let filter {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(sessions)/\(session)/line_items", query: queryParams, headers: headers)
  }
}
