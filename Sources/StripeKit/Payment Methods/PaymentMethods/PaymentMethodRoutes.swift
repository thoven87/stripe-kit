...
public struct StripePaymentMethodRoutes: PaymentMethodRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: paymentmethods, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(paymentMethod: String, expand: [String]? = nil) async throws -> PaymentMethod
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(paymentmethods)/\(paymentMethod)", query: queryParams, headers: headers
    )
  }
  ...
  public func attach(paymentMethod: String, customer: String, expand: [String]? = nil) async throws
    -> PaymentMethod
  {
