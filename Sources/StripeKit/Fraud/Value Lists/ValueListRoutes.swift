...
public protocol ValueListRoutes: StripeAPIRoute {
  ...
  func create(
    alias: String, name: String, itemType: ValueListItemType?, metadata: [String: String]?
  ) async throws -> ValueList
  ...
  func update(valueList: String, alias: String?, metadata: [String: String]?, name: String?)
    async throws -> ValueList
...
public struct StripeValueListRoutes: ValueListRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: valuelists, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(valuelists)/\(valueList)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> ValueListList {
    ...
    return try await apiHandler.send(
      method: .GET, path: valuelists, query: queryParams, headers: headers)
  }
}
