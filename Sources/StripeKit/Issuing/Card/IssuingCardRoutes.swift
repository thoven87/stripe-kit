...
public struct StripeIssuingCardRoutes: IssuingCardRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: issuingcards, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func retrieve(card: String, expand: [String]? = nil) async throws -> IssuingCard {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(issuingcards)/\(card)", query: queryParams, headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(issuingcards)/\(card)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> IssuingCardList {
    ...
    return try await apiHandler.send(
      method: .GET, path: issuingcards, query: queryParams, headers: headers)
  }
  ...
  public func ship(card: String, expand: [String]? = nil) async throws -> IssuingCard {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(testhelpers)/\(card)/shipping/ship",
  ...
  public func deliver(card: String, expand: [String]? = nil) async throws -> IssuingCard {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(testhelpers)/\(card)/shipping/deliver",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func `return`(card: String, expand: [String]? = nil) async throws -> IssuingCard {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(testhelpers)/\(card)/shipping/return",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func fail(card: String, expand: [String]? = nil) async throws -> IssuingCard {
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(testhelpers)/\(card)/shipping/fail",
      body: .string(body.queryParameters), headers: headers)
  }
}
