...
public struct StripeIssuingDisputeRoutes: IssuingDisputeRoutes {
  ...
  public func create(
    ...
    return try await apiHandler.send(
      method: .POST, path: issuingdisputes, body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func submit(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(issuingdisputes)/\(dispute)/submit",
  ...
  public func retrieve(dispute: String, expand: [String]?) async throws -> IssuingDispute {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(issuingdisputes)/\(dispute)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(issuingdisputes)/\(dispute)", body: .string(body.queryParameters),
      headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> IssuingDisputeList {
    ...
    return try await apiHandler.send(
      method: .GET, path: issuingdisputes, query: queryParams, headers: headers)
  }
}
