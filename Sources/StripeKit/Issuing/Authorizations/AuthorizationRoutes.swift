...
public protocol AuthorizationRoutes: StripeAPIRoute {
  ...
  func update(authorization: String, metadata: [String: String]?, expand: [String]?) async throws
    -> Authorization
  ...
  func decline(authorization: String, metadata: [String: String]?, expand: [String]?) async throws
    -> Authorization
...
public struct StripeAuthorizationRoutes: AuthorizationRoutes {
  ...
  public func retrieve(authorization: String, expand: [String]? = nil) async throws -> Authorization
  {
    ...
    return try await apiHandler.send(
      method: .GET, path: "\(authorizations)/\(authorization)", query: queryParams, headers: headers
    )
  }
  ...
  public func update(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(authorizations)/\(authorization)",
  ...
  public func approve(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(authorizations)/\(authorization)/approve",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func decline(
    ...
    return try await apiHandler.send(
      method: .POST, path: "\(authorizations)/\(authorization)/decline",
      body: .string(body.queryParameters), headers: headers)
  }
  ...
  public func listAll(filter: [String: Any]? = nil) async throws -> AuthorizationList {
    ...
    return try await apiHandler.send(
      method: .GET, path: authorizations, query: queryParams, headers: headers)
  }
}
