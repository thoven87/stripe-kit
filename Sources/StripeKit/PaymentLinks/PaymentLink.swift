...
public struct PaymentLinkAfterCompletion: Codable {
  ...
  public init(
    hostedConfirmation: PaymentLinkAfterCompletionHostedConfirmation? = nil,
...
public struct PaymentLinkCustomField: Codable {
  ...
  public init(
    dropdown: PaymentLinkCustomFieldDropdown? = nil,
    key: String? = nil,
...
public struct PaymentLinkPaymentIntentData: Codable {
  ...
  public init(
    captureMethod: PaymentLinkPaymentIntentDataCaptureMethod? = nil,
